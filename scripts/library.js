...
const modalBuyLink = document.querySelector('.modal-content .buy'); // Botão "Buy"
const closeModal = document.querySelector('.close-btn');

// Lista de livros com título, descrição e link de compra
const books = [
    {
...
const openModal = (index) => {
    ...
    modalBuyLink.href = books[index].link; // Define o link correto
    modalBuyLink.target = "_blank"; // Abre o link em nova aba
    modal.style.display = 'flex';
};

// Adiciona evento a cada link "Learn more"
